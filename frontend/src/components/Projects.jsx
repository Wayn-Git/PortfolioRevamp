      ...
      <div className="p-4 sm:p-6">
             ...
             <div className="flex items-center justify-center sm:justify-end space-x-2 order-2 sm:order-2 flex-shrink-0 w-full sm:w-auto">
               {project.githubUrl && (
                 <button
                   ...
                   className="flex items-center justify-center p-2.5 sm:p-3 bg-gray-100 dark:bg-gray-700 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300 hover:scale-110 group min-w-[44px] min-h-[44px]"
                   aria-label="View on GitHub"
                 >
                   <Github size={18} className="sm:w-4 sm:h-4 text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400" />
                 </button>
               )}
               {project.demoUrl && (
                 <button
                 ...
                 >
                   <ExternalLink size={18} className="sm:w-4 sm:h-4 text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400" />
                 </button>
               )}
             </div>
          </div>
        ...
        <div className={`flex flex-wrap gap-2 mb-3 sm:mb-4 transition-all duration-600 ease-out ${
          ...
          {project.techStack.map((tech, index) => (
            <span
              key={index}
              className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium border border-gray-100 dark:border-gray-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:text-purple-700 dark:hover:text-purple-400 hover:border-purple-200 dark:hover:border-purple-700 transition-all duration-300 text-xs sm:text-sm"
            >
              {tech}
            </span>
          ))}
        ...
        <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
          <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16 sm:mt-20 lg:mt-24">
          <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl border border-gray-100 dark:border-gray-700 p-6 sm:p-8 lg:p-12 max-w-4xl mx-auto hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
            ...
            <a
              href="#contact"
              className="inline-flex items-center space-x-3 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-300 hover:scale-105 hover:shadow-xl font-medium text-base sm:text-lg"
            >
